...
1. Abre tu navegador y entra a la página oficial de Python: https://www.python.org/downloads/windows/
2. Descarga la versión Python 3.11.x para Windows.
3. Ejecuta el instalador descargado.
4. Muy importante: marca la opción Add Python to PATH.
5. Haz clic en Install Now.
6. Espera a que termine la instalación.

### Verificar la instalación

Después de instalarlo, abre PowerShell o CMD y ejecuta:
...
### 2. Alternativa: descargar el proyecto en ZIP
...
Si no funciona o falta alguna dependencia, instala manualmente:

```powershell
pip install flask flask-cors numpy scikit-learn nltk sentence-transformers openpyxl
```
...
A continuación se muestran ejemplos de preguntas con su respuesta de referencia y una respuesta del alumno. Estos casos sirven para probar el sistema con respuestas muy parecidas y también con respuestas no relacionadas, para observar cómo cambian la similitud semántica, la similitud léxica y la calificación general.
